...
$GLOBALS['tmpl']->template_dir   = APP_ROOT_PATH . 'Application/Tpl/' . app_conf("TEMPLATE");
//定义当前语言包
//定义模板路径
$tmpl_path = get_domain().APP_ROOT."/Application/Tpl/";
$GLOBALS['tmpl']->assign("TMPL",$tmpl_path.app_conf("TEMPLATE"));
$GLOBALS['tmpl']->assign("TMPL_REAL",APP_ROOT_PATH."Application/Tpl/".app_conf("TEMPLATE")); 
...
require APP_ROOT_PATH.'Application/Lib/BaseModule.class.php';
define("CTL",'m');
define("ACT",'f');
...
if(!file_exists(APP_ROOT_PATH."Application/Lib/modules/".$module."Module.class.php"))
$module = "index";

require_once APP_ROOT_PATH."Application/Lib/modules/".$module."Module.class.php";				
